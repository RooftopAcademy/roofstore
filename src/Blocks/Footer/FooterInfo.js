    ...
    return (
        <div className='row'>
            <div className='col'>
                ...
                <TextLine className={'txt-light-grey m-top-0 txt-start'} text={'© 1999-2021 MercadoLibre S.R.L.'}/>
                <TextLine className={'txt-light-grey txt-start'} text={'Av. Caseros 3039, Piso 2, CP 1264, Parque Patricios, CABA'}/>
            </div>
        </div>
    )
}
